...
<#
	...
	.NOTES
		...
		Version    : 0.4
		History    : 0.4   FN  15.07.2020  Update Schemas, integrate LAPS detection
...
# Forrest creation
Write-Host "Creation date of the domains"
Write-Host "============================"
...
# Fuctional Levels
Write-Host "Funtional Level and FSMO roles"
Write-Host "=============================="
...
# List DCs
Write-Host "List of all domain controllers"
Write-Host "=============================="
try 
        { 
...
15312="Exchange 2013 CU7 - CU12";
15317="Exchange 2016 RTM / Preview";
15323="Exchange 2016 CU1";
15325="Exchange 2016 CU2";
15326="Exchange 2016 CU3/4/5";
15330="Exchange 2016 CU6";
15332="Exchange 2016 CU7/8/9/10/11/12 or Exchange 2019 Preview";
...
IF ((Get-ADObject -Filter  'Name -like "ms-Mcs-AdmPwd"' -SearchBase $Schemapath -Properties Name)) { Write-Host "Schema is LAPS ready" } Else  { Write-Host "Schema is NOT LAPS ready" }
